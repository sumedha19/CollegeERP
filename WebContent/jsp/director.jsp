...
<% 
String str="select name from employee where emp_id=?";
String ui=(String)request.getAttribute("did");
...
<div style="height:20px;float:left;text-align:center;border-style:solid;border-color:#F1F1F1;color:#868686;width:215px;font-family:Comic Sans MS">
<a href="/college_erp/jsp/markmd.jsp" target="f1" style="text-decoration: none;">Marks Management</a></div>
<div style="height:20px;float:left;text-align:center;border-style:solid;border-color:#F1F1F1;color:#868686;width:215px;font-family:Comic Sans MS">
<a href="/college_erp/jsp/attendancemd.jsp" target="f1" style="text-decoration: none;">Attendance Management</a></div>
<div style="height:20px;float:left;text-align:center;border-style:solid;border-color:#F1F1F1;color:#868686;width:215px;font-family:Comic Sans MS">
<a href="/college_erp/jsp/studentmd.jsp" target="f1" style="text-decoration: none;">Student Management</a></div>
<div style="height:20px;float:left;text-align:center;border-style:solid;border-color:#F1F1F1;color:#868686;width:215px;font-family:Comic Sans MS">
<a href="/college_erp/jsp/employeemd.jsp" target="f1" style="text-decoration: none;">Employee Management</a></div>
<div style="height:20px;float:left;text-align:center;border-style:solid;border-color:#F1F1F1;color:#868686;width:215px;font-family:Comic Sans MS">
