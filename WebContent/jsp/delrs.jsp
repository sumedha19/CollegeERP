...
<div style="margin-top:10px;margin-left:20px;text-decoration: underline;">Delete Record</div>
<form method="post" action="/college_erp/Delrs" style="margin-left:50px;margin-top:20px">
