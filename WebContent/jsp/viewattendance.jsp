...
<form method="post" action="/college_erp/jsp/viewa.jsp" >
...
<tr><td>Date :</td><td><input type="date" name="dt" required="required">
</table>
<input type="submit" value="VIEW" style="margin-left:145px" onclick="return check()">
