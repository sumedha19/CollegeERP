...
{
%>
<form method="post" action="/college_erp/Topdfemp" style="margin-left:800px;float:left;margin-top:20px">
<input type="text" name="emp" value='<%=r %>' style="display:none">
<input type="submit" value="Export as pdf" style="background-color:white">
</form>
<div style="background-color:#f7f7f7;width:900px;margin-left:100px;height:400px;margin-top:50px;border-style:solid;border-color:#f1f1f1;float:left">
