...
<% 
String str="select name from student where rollno=?";
String ui=(String)request.getAttribute("roll");
...
<a href="/college_erp/jsp/viewprofile.jsp" target="f1" style="text-decoration: none;">View Profile</a></div>
<div style="height:20px;float:left;text-align:center;border-style:solid;border-color:#F1F1F1;color:#868686;width:215px;font-family:Comic Sans MS">
<a href="/college_erp/jsp/change_pwd.jsp" target="f1" style="text-decoration: none;">Change Password</a></div>
<div style="height:20px;float:left;text-align:center;border-style:solid;border-color:#F1F1F1;color:#868686;width:215px;font-family:Comic Sans MS">
<a href="/college_erp/jsp/viewmarkk.jsp" target="f1" style="text-decoration: none;">View Marks</a></div>
<div style="height:20px;float:left;text-align:center;border-style:solid;border-color:#F1F1F1;color:#868686;width:215px;font-family:Comic Sans MS">
<a href="/college_erp/jsp/attendance.jsp" target="f1" style="text-decoration: none;">Attendance</a></div>
<div style="height:20px;float:left;text-align:center;border-style:solid;border-color:#F1F1F1;color:#868686;width:215px;font-family:Comic Sans MS">
