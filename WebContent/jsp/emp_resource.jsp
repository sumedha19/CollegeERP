...
<div style="height:20px;float:left;text-align:center;border-style:solid;border-color:#F1F1F1;color:#868686;width:215px;font-family:Comic Sans MS">
<a href="/college_erp/jsp/addresources.jsp" target="f1" style="text-decoration: none;">Add Resources</a></div>
<div style="height:20px;float:left;text-align:center;border-style:solid;border-color:#F1F1F1;color:#868686;width:215px;font-family:Comic Sans MS">
<a href="/college_erp/jsp/updaters.jsp" target="f1" style="text-decoration: none;">Update Record</a></div>
<div style="height:20px;float:left;text-align:center;border-style:solid;border-color:#F1F1F1;color:#868686;width:215px;font-family:Comic Sans MS">
<a href="/college_erp/jsp/viewrs.jsp" target="f1" style="text-decoration: none;">View Records</a></div>
<div style="height:20px;float:left;text-align:center;border-style:solid;border-color:#F1F1F1;color:#868686;width:215px;font-family:Comic Sans MS">
